...
def example_scoring():
    ...
    from app.xb_strategy.core.types import SevenDimScore
...
def example_events():
    ...
    from app.xb_strategy.core.events import (
...
def example_hedge():
    ...
    from app.xb_strategy.core.timing import TimingSignal
