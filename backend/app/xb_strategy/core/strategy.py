...
# 导入各模块
from app.xb_strategy.core.filters import VetoFilter, EnhancedVetoFilter
...
from app.xb_strategy.core.events import EventDrivenEngine
from app.xb_strategy.core.hedge import HedgeEngine
from app.xb_strategy.core.execution import ExecutionEngine
...
class StructuredLogger:
    ...
    def __init__(self, name: str, log_level: str = "INFO"):
        ...
        # 添加文件handler（可选）
        log_dir = os.environ.get('XB_STRATEGY_LOG_DIR', '/tmp/xb_strategy_logs')
