...
class ChaosEngine:
    ...
    def __init__(self, kubectl_path: str = "kubectl", namespace: str = "sg-strategy"):
...
class AutomatedChaosTests:
    ...
    def test_service_resilience(self) -> Dict[str, Any]:
        ...
        self.engine.register_steady_state_check(SteadyStateCheck(
            name="api_health",
            check_func=lambda: SteadyStateChecker.check_api_health("https://api.sg-strategy.com"),
        ))
...
def create_chaos_engine(namespace: str = "sg-strategy") -> ChaosEngine:
    """创建混沌引擎"""
