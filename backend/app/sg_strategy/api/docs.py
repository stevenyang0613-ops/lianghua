...
API_INFO = {
    "title": "松岗量化可转债策略 V3.0 API",
    "description": """
## 概述

松岗量化可转债策略系统是一套完整的量化交易解决方案，提供可转债打分、信号生成、组合管理、风险控制等功能。
...
""",
    ...
    "contact": {
        "name": "松岗量化团队",
        "email": "support@sg-strategy.com",
        "url": "https://sg-strategy.com",
    },
    "license_info": {
        "name": "MIT",
    ...
    "servers": [
        {
            "url": "https://api.sg-strategy.com",
            "description": "生产环境",
        },
        {
            "url": "https://staging-api.sg-strategy.com",
            "description": "测试环境",
        },
        {
...
<head>
    <meta charset="UTF-8">
    <title>松岗量化可转债策略 V3.0 API 文档</title>
